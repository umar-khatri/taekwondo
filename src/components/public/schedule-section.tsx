  ...
  return (
    <section id="schedule" className="py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <Card className="max-w-lg mx-auto border-border/50 bg-card/80 card-hover overflow-hidden">
          {/* Header */}
          <div className="bg-primary/5 border-b border-border/50 px-6 py-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">All ages & skill levels welcome</p>
          </div>
          ...
          <CardContent className="pt-6">
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-muted/50 border border-border/50">
              ...
              <div>
                <p className="font-semibold text-lg">{ACADEMY_INFO.schedule.time}</p>
